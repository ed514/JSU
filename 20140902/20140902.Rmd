...
```{r, echo = TRUE, eval = TRUE, cache = TRUE, tidy_source = TRUE}
...
```{r, echo = TRUE, eval = TRUE, tidy_source = TRUE}
# Load the graph package we installed last week
library("ggplot2")
```
```{r, echo = TRUE, eval = FALSE, tidy_source = TRUE}
...
```{r, echo = TRUE, eval = TRUE, tidy_source = TRUE, fig.align = 'center', fig.width = 11, fig.height = 7}
...
```{r, echo = TRUE, eval = TRUE, tidy_source = TRUE, fig.align = 'center', fig.width = 11, fig.height = 6.5}
...
```{r, echo = TRUE, eval = TRUE, tidy_source = TRUE, fig.align = 'center', fig.width = 11, fig.height = 6}
