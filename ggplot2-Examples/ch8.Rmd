...
subtitle: "Chapter 8: Polishing your plots for publication"
author: "Wickham, Hadley"
output: html_document
---

The original source code can be downloaded from [http://ggplot2.org/book/polishing.r](the book website).
