...
## Announcements
* Task 4 is due by Friday night 21nov2014
* Many people missed the opportunity to resubmit task 3
* You are expected to do the course readings and prepare for class
...
* What measurement scales should the variables be measured on for the correlations
...
```{r, eval = TRUE, echo = TRUE, tidy = TRUE, fig.height = 5, fig.width = 7, fig.align = "center"}
...
```{r, eval = TRUE, echo = TRUE, tidy = TRUE}
# The first variable in the function should be your total score
# The second variable in the function MUST BE a DICHOTOMOUS (e.g., 0 or 1) variable
...
f <- function(dF, i) { 
		...
		# We want to return the value of the biserial correlation for the group
		# with the correct responses (level = 1 would give you the group with 
		# incorrect responses); change dataSample$V13 to dataSample$V# to use 
		# this function for other test items
