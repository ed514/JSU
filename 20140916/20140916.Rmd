...
# Loading source directly from GitHub is not quite so easy.  
# So, we'll download the file first
download.file("https://github.com/ed514/JSU/blob/master/20140916/getRGraphicsExamples.R", 
              "getRGraphicsExamples.R", method = "curl")

# Then we can load the function
