...
```{r, eval = TRUE, echo = TRUE, tidy = TRUE}
# So far so good, everything looks the same, but what if we tried to use a math function
# on the nominal vector?  Any Guesses?
mean(make2)
make2[3] == make2[3]
make2[3] != make2[3]
```
...
```{r, eval = TRUE, echo = TRUE, tidy = TRUE}
# Set the random number seed so you'll generate the same random numbers as me
set.seed(7779311)
...
```{r, eval = TRUE, echo = TRUE, tidy = TRUE}
# Create a variable/vector with the number of absences over the year for students
...
```{r, echo = TRUE, eval = TRUE, cache = FALSE, tidy = TRUE, error = FALSE}
...
# Create a new object to store your intervallic/ratio scale data for the graphs 
# and identify the x-axis variable
...
```{r, echo = TRUE, eval = TRUE, tidy = TRUE, fig.align = 'center', fig.width = 11, fig.height = 7, cache = FALSE, warning = FALSE}
# You probably are wondering where the graph is...if you want to see it enter
baseHistogram 
```
...
```{r, echo = TRUE, eval = TRUE, tidy = TRUE, fig.align = 'center', fig.width = 11, fig.height = 7, cache = FALSE}
# Here is the combination of all the different histograms from last week layered on top of each other
baseHistogram.4
```
...
```{r, echo = TRUE, eval = TRUE, tidy = TRUE, fig.align = 'center', fig.width = 11, fig.height = 7, cache = FALSE}
# Create an object to store the data for the graphs and identify the x-axis variable
...
```{r, echo = TRUE, eval = TRUE, tidy = TRUE, fig.align = 'center', fig.width = 11, fig.height = 7, cache = FALSE, warning = FALSE}
# What would the density look like with a different kernel density estimator?
...
```{r, echo = TRUE, eval = TRUE, tidy = TRUE, fig.align = 'center', fig.width = 11, fig.height = 5, cache = FALSE, warning = FALSE}
...
```{r, eval = TRUE, echo = TRUE, cache = FALSE, tidy = TRUE}
# Set the working directory for your computer (it will look different from mine)
